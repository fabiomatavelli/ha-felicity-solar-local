...
- **Nothing hidden**: an optional diagnostic "Raw data" sensor exposes the complete device
  ...
  Configuration below).
- **Translated**: English, Portuguese (Brazil and Portugal), Spanish, German, French and
  Italian. Spotted an awkward translation? PRs from native speakers are very welcome.
